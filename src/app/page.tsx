              ...
              <Box className="w-1/3 space-y-2">
                ...
                <Box className="gap-x-1 flex">
                  ...
                  <Box className="space-y-2">
                    ...
                    <Typography variant="body1" className="text-gray-300 text-sm">
                      As encapsulation costs decrease and computational resources are optimized, more data is motivated
                      to be stored on the Filecoin network, enhancing its value and fostering the growth of the
